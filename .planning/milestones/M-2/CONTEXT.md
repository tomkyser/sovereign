...
**Build:** `pnpm build` → 160KB | **Verify:** `node dist/index.mjs check` → 17/17 SOVEREIGN
...
| 2c: Clean-Room Tungsten | RESEARCHED — 6 deliverables scoped, binary analysis complete |
